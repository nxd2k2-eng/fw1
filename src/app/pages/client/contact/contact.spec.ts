...
export class Contact {
  ...
  infos = [
    { icon: '📍', label: 'Địa chỉ',      value: '123 Nguyễn Văn Cừ, Ninh Kiều, Cần Thơ' },
    { icon: '📞', label: 'Điện thoại',   value: '0901 234 567' },
    { icon: '✉️', label: 'Email',         value: 'support@shoeshop.vn' },
    { icon: '🕐', label: 'Giờ làm việc', value: 'T2–T7: 8:00–21:00 | CN: 9:00–18:00' },
  ];
